...
override SBT_OPTS += -Dsbt.sourcemode=true -Dsbt.workspace=$(base_dir)/hardware/chipyard/tools

SCALA_BUILDTOOL_DEPS = $(SBT_SOURCES)

SBT_THIN_CLIENT_TIMESTAMP = $(base_dir)/hardware/chipyard/project/target/active.json
