...
SOURCE_DIRS = $(addprefix $(base_dir)/hardware/chipyard/,generators sims/firesim/sim tools/barstools/iocell fpga/fpga-shells fpga/src)
...
#########################################################################################
$(sim_files): $(call lookup_srcs,$(base_dir)/hardware/chipyard/generators/utilities/src/main/scala,scala) $(SCALA_BUILDTOOL_DEPS)
